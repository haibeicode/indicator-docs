...
.. seealso::
  Init Function::
    ...
    from indicator.technology.dragon import *
...
.. py:function:: RAD(df, dp, D=3, S=30, M=30)
  :module: indicator.technology.dragon
  ...
  :param M: 天数
  :return:
    :RADER1: (SI1-II)*2的S日累和*1000
    :RADERMA: RADER1的M日[1日权重]移动平均
...
.. py:function:: ZLMM(df)
  ...
  :param df: DataFrame
  :return:
    :MMS: 3*RSI2-2*收盘价-LC和0的较大值的16日[1日权重]移动平均/收盘价-LC的绝对值的16日[1日权重]移动平均*100的3日简单移动平均
    :MMM: MMS的8日指数移动平均
    :MML: 3*RSI3-2*收盘价-LC和0的较大值的12日[1日权重]移动平均/收盘价-LC的绝对值的12日[1日权重]移动平均*100的5日简单移动平均
